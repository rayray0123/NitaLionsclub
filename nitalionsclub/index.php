...
<body>
    ...
    <div class="info-wrap margin-0-auto top">
        <!--環境保全に動く-->
        <div class="info">
            <a href="./info-env1.php" class="text-decoration">
        ...
        <!--子供たちを支援する-->
        <div class="info">
            <a href="./info-child2.php" class="text-decoration">
        ...
        <!--安全に奉仕する-->
        <div class="info">
            <a href="./info-safety3.php" class="text-decoration">
        ...
        <!--福祉に貢献する-->
        <div class="info">
            <a href="./info-welfare4.php" class="text-decoration">
